...
After the `survtable` has been created, in principle the following steps can be automated and included in a single function (to be created). However, they are shown here to show the entire process.  
