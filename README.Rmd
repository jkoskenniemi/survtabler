...
A simple example using simulated data. Using imperative programming, the analysis require a lot of repetitive writing of same blocks of code, and would look like this (please suggest if this can be shortened).
...
survtable_1 <- 
  ...
  create_survtable(exposure_vars = c("slope_1", "slope_2", "age_cp"),
                 outcome_vars = c("any_ia", "iaa_first", "gada_first"),
                 covariates = "sex + fdr + hla",
                 # submodel_var = "hla",
